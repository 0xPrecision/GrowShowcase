...
_current_locale: contextvars.ContextVar[str] = contextvars.ContextVar("locale", default="ru")
...
def _ru_pl(n: int) -> str:
    n = abs(int(n)); n100 = n % 100; n10 = n % 10
...
class Translator:
    def __init__(self, locales_dir: Path, default_locale: str = "ru", supported: tuple[str, ...] = ("ru", "en")):
